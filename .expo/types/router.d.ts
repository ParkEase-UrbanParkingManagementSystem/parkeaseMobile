...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(routes)/` | `/(routes)/(tabs)` | `/(routes)/QR` | `/(routes)/activities` | `/(routes)/add-vehicle` | `/(routes)/choose-vehicle` | `/(routes)/forgot-password` | `/(routes)/home-page` | `/(routes)/info` | `/(routes)/login` | `/(routes)/onboarding` | `/(routes)/parking-lot` | `/(routes)/payment/bill` | `/(routes)/payment/paymentMethods` | `/(routes)/payment/wallet` | `/(routes)/profile` | `/(routes)/sign-up` | `/(routes)/verifyAccount` | `/(routes)/welcome-intro` | `/(tabs)` | `/QR` | `/_sitemap` | `/activities` | `/add-vehicle` | `/choose-vehicle` | `/forgot-password` | `/history.screen` | `/home-page` | `/info` | `/login` | `/onGoing.screen` | `/onboarding` | `/parking-lot` | `/payment/bill` | `/payment/paymentMethods` | `/payment/wallet` | `/permits.screen` | `/profile` | `/sign-up` | `/verifyAccount` | `/welcome-intro`;
