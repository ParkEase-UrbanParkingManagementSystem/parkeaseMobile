...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(routes)/QR` | `/(routes)/activities` | `/(routes)/add-vehicle` | `/(routes)/choose-vehicle` | `/(routes)/forgot-password` | `/(routes)/home-page` | `/(routes)/login` | `/(routes)/onboarding` | `/(routes)/parking-lot` | `/(routes)/payment` | `/(routes)/profile` | `/(routes)/sign-up` | `/(routes)/verifyAccount` | `/(routes)/welcome-intro` | `/QR` | `/_sitemap` | `/activities` | `/add-vehicle` | `/choose-vehicle` | `/forgot-password` | `/home-page` | `/login` | `/onboarding` | `/parking-lot` | `/payment` | `/profile` | `/sign-up` | `/verifyAccount` | `/welcome-intro`;
