...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(routes)/change-vehicle` | `/(routes)/choose-vehicle` | `/(routes)/forgot-password` | `/(routes)/home-page` | `/(routes)/login` | `/(routes)/onboarding` | `/(routes)/profile` | `/(routes)/sign-up` | `/(routes)/verifyAccount` | `/(routes)/welcome-intro` | `/_sitemap` | `/change-vehicle` | `/choose-vehicle` | `/forgot-password` | `/home-page` | `/login` | `/onboarding` | `/profile` | `/sign-up` | `/verifyAccount` | `/welcome-intro`;
